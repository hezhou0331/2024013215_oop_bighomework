...
public:
    ...
    //【函数功能】       拷贝构造函数；导出器以注册实例形式共享使用，禁止复制实例，避免工厂登记表中出现语义不清的副本。
    //【参数】           Source（输入参数）：被拷贝的导出器对象。
    //【返回值】         无。
    //【开发者及日期】   刘江宇, 2026-07-07
    //【更改记录】       无
    //-------------------------------------------------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------------------------------------------------
    //【函数名称】       Exporter::operator=
    //【函数功能】       拷贝赋值运算符；导出器注册后由工厂统一管理，禁止对象间赋值。
    //【参数】           Source（输入参数）：赋值来源的导出器对象。
    //【返回值】         Exporter<T>&，当前导出器对象引用；本函数被删除，不能被调用。
    //【开发者及日期】   刘江宇, 2026-07-07
    //【更改记录】       无
    //-------------------------------------------------------------------------------------------------------------------
...
protected:
    ...
    //-------------------------------------------------------------------------------------------------------------------
    //【函数名称】       Exporter::Exporter
    //【函数功能】       带参构造函数；指定本导出器支持的文件扩展名，扩展名不可为空。
    //【参数】           FileExtName（输入参数）：本导出器支持的扩展名，不含点号。
    //【返回值】         无。
    //【开发者及日期】   刘江宇, 2026-07-07
    //【更改记录】       无
    //-------------------------------------------------------------------------------------------------------------------
