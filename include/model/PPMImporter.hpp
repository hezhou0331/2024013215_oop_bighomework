...
public:
    ...
    //【函数功能】       拷贝构造函数；PPM 导入器以注册实例形式共享使用，禁止复制实例。
    //【参数】           Source（输入参数）：被拷贝的 PPM 导入器对象。
    //【返回值】         无。
    ...
    //-------------------------------------------------------------------------------------------------------------------
    //【函数名称】       PPMImporter::operator=
    //【函数功能】       拷贝赋值运算符；PPM 导入器注册后由工厂统一管理，禁止对象间赋值。
    //【参数】           Source（输入参数）：赋值来源的 PPM 导入器对象。
    //【返回值】         PPMImporter&，当前导入器对象引用；本函数被删除，不能被调用。
    //【开发者及日期】   刘江宇, 2026-07-07
    //【更改记录】       无
    //-------------------------------------------------------------------------------------------------------------------
