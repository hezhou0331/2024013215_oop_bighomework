...
public:
    ...
    //【函数功能】       拷贝构造函数；控制器采用单例模式，禁止复制控制器对象，确保业务状态入口唯一。
    //【参数】           Source（输入参数）：被拷贝的控制器对象。
    //【返回值】         无。
    //【开发者及日期】   刘江宇, 2026-07-07
    //【更改记录】       无
    //-------------------------------------------------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------------------------------------------------
    //【函数名称】       ProjectController::operator=
    //【函数功能】       拷贝赋值运算符；控制器采用单例模式，禁止对象间赋值，避免当前项目状态被覆盖。
    //【参数】           Source（输入参数）：赋值来源的控制器对象。
    //【返回值】         ProjectController&，当前控制器对象引用；本函数被删除，不能被调用。
    //【开发者及日期】   刘江宇, 2026-07-07
    //【更改记录】       无
    //-------------------------------------------------------------------------------------------------------------------
