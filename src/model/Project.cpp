...
//-------------------------------------------------------------------------------------------------------------------
//【函数名称】       Project::Project
//【函数功能】       以给定名称构造空项目，并校验名称非空。
//【参数】           Name（输入参数）：项目名称，不允许为空字符串。
//【返回值】         构造函数无返回值；名称为空时抛出 std::invalid_argument。
//【开发者及日期】   2024013215, 2026-07-05
//【更改记录】
//-------------------------------------------------------------------------------------------------------------------
...
//【返回值】         void，无返回值；名称为空时抛出 std::invalid_argument。
//【开发者及日期】   2024013215, 2026-07-05
//【更改记录】
//-------------------------------------------------------------------------------------------------------------------
...
//【返回值】         void，无返回值；索引越界时抛出 std::out_of_range。
//【开发者及日期】   2024013215, 2026-07-05
//【更改记录】
//-------------------------------------------------------------------------------------------------------------------
...
//【返回值】         void，无返回值；索引越界、重名或工期为负时抛出异常。
//【开发者及日期】   2024013215, 2026-07-05
//【更改记录】
//-------------------------------------------------------------------------------------------------------------------
...
//【返回值】         void，无返回值；任务或资源索引越界时抛出 std::out_of_range。
//【开发者及日期】   2024013215, 2026-07-05
//【更改记录】
//-------------------------------------------------------------------------------------------------------------------
...
//【返回值】         void，无返回值；引用非法或依赖重复时抛出 std::invalid_argument。
//【开发者及日期】   2024013215, 2026-07-05
//【更改记录】
//-------------------------------------------------------------------------------------------------------------------
...
//【返回值】         void，无返回值；对应依赖不存在时抛出 std::invalid_argument。
//【开发者及日期】   2024013215, 2026-07-05
//【更改记录】
//-------------------------------------------------------------------------------------------------------------------
