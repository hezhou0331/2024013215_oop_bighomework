...
本 README 是仓库的主入口，面向第一次阅读项目的人，重点说明项目能做什么、如何运行、源码如何分层以及应该按什么顺序阅读。仓库中的 `FINAL_*.md`、`*_SUMMARY.txt`、`SPRINT_ASSESSMENT.md` 等文件是迭代审查和自查记录，不是理解或运行项目所必需的入口文件。
...
仓库中保留了一些过程性文档，用于记录迭代改进和自查过程。这些文件可以帮助追溯修改历史，但不是理解项目的必要入口。首次阅读时，建议优先关注：
